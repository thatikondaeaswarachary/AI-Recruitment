...
# Name & Date
name_date = document.add_paragraph('Name: Priya Anand\nDate: 07 January 2026')
...
# Module 1
document.add_heading('Module 1: Authentication Service', level=3)
...
document.add_paragraph('Backend: database.py')
...
document.add_paragraph('Backend: models.py')
...
# Module 3
document.add_heading('Module 3: Term Search Service', level=3)
...
document.save('ConceptClarity_Documentation.docx')
